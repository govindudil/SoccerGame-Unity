...
public class Game : MonoBehaviour
{
    ...
    [SerializeField] private GameObject playerSpawnPosition5;
    [SerializeField] private GameObject playerSpawnPosition6;
    [SerializeField] private GameObject playerSpawnPosition7;
    [SerializeField] private GameObject playerSpawnPosition8;
    [SerializeField] private GameObject playerSpawnPosition9;
    [SerializeField] private GameObject playerSpawnPosition10;
    ...
    [SerializeField] private GameObject pfPlayer5;
    [SerializeField] private GameObject pfPlayer6;
    [SerializeField] private GameObject pfPlayer7;
    [SerializeField] private GameObject pfPlayer8;
    [SerializeField] private GameObject pfPlayer9;
    [SerializeField] private GameObject pfPlayer10;
    ...
    public void Awake()
    {
        ...
        spawnedHumanPlayer.name = "Team A - P1";
        ...
        spawnedHumanPlayer2.name = "Team A - P2";
        ...
        GameObject spawnedHumanPlayer3 = Instantiate(pfPlayer5, playerSpawnPosition5.transform.position, Quaternion.identity);
        spawnedHumanPlayer3.name = "Team A - P3";
        spawnedHumanPlayer3.GetComponent<Player>().Number = 2;
        spawnedHumanPlayer3.GetComponent<Player>().Team = team1;
        spawnedHumanPlayer3.GetComponent<PlayerInput>().enabled = false;
        spawnedHumanPlayer3.GetComponent<Player>().HumanControlled = false;
        spawnedHumanPlayer3.GetComponent<CharacterController>().enabled = false;
        team1.Players.Add(spawnedHumanPlayer3.GetComponent<Player>());
        //
        GameObject spawnedHumanPlayer4 = Instantiate(pfPlayer6, playerSpawnPosition6.transform.position, Quaternion.identity);
        spawnedHumanPlayer4.name = "Team A - P4";
        spawnedHumanPlayer4.GetComponent<Player>().Number = 3;
        spawnedHumanPlayer4.GetComponent<Player>().Team = team1;
        spawnedHumanPlayer4.GetComponent<PlayerInput>().enabled = false;
        spawnedHumanPlayer4.GetComponent<Player>().HumanControlled = false;
        spawnedHumanPlayer4.GetComponent<CharacterController>().enabled = false;
        team1.Players.Add(spawnedHumanPlayer4.GetComponent<Player>());
        //
        GameObject spawnedHumanPlayer5 = Instantiate(pfPlayer7, playerSpawnPosition7.transform.position, Quaternion.identity);
        spawnedHumanPlayer5.name = "Team A - P5";
        spawnedHumanPlayer5.GetComponent<Player>().Number = 4;
        spawnedHumanPlayer5.GetComponent<Player>().Team = team1;
        spawnedHumanPlayer5.GetComponent<PlayerInput>().enabled = false;
        spawnedHumanPlayer5.GetComponent<Player>().HumanControlled = false;
        spawnedHumanPlayer5.GetComponent<CharacterController>().enabled = false;
        team1.Players.Add(spawnedHumanPlayer5.GetComponent<Player>());
        //
        ...
        spawnedHumanPlayer3.GetComponent<Player>().FellowPlayer = spawnedHumanPlayer.GetComponent<Player>();
        spawnedHumanPlayer4.GetComponent<Player>().FellowPlayer = spawnedHumanPlayer.GetComponent<Player>();
        spawnedHumanPlayer5.GetComponent<Player>().FellowPlayer = spawnedHumanPlayer.GetComponent<Player>();
        ...
        spawnedAIPlayer.name = "Team B - P1";
        ...
        spawnedAIPlayer2.name = "Team B - P2";
        ...
        //Adding Additional AI players
        GameObject spawnedAIPlayer3 = Instantiate(pfPlayer8, playerSpawnPosition8.transform.position, Quaternion.identity);
        spawnedAIPlayer3.name = "Team B - P3";
        spawnedAIPlayer3.GetComponent<Player>().Number = 2;
        spawnedAIPlayer3.GetComponent<Player>().Team = team2;
        spawnedAIPlayer3.GetComponent<PlayerInput>().enabled = false;
        spawnedAIPlayer3.GetComponent<Player>().HumanControlled = false;
        spawnedAIPlayer3.GetComponent<CharacterController>().enabled = false;
        team2.Players.Add(spawnedAIPlayer3.GetComponent<Player>());
        //
        GameObject spawnedAIPlayer4 = Instantiate(pfPlayer9, playerSpawnPosition9.transform.position, Quaternion.identity);
        spawnedAIPlayer4.name = "Team B - P4";
        spawnedAIPlayer4.GetComponent<Player>().Number = 3;
        spawnedAIPlayer4.GetComponent<Player>().Team = team2;
        spawnedAIPlayer4.GetComponent<PlayerInput>().enabled = false;
        spawnedAIPlayer4.GetComponent<Player>().HumanControlled = false;
        spawnedAIPlayer4.GetComponent<CharacterController>().enabled = false;
        team2.Players.Add(spawnedAIPlayer4.GetComponent<Player>());
        //
        GameObject spawnedAIPlayer5 = Instantiate(pfPlayer10, playerSpawnPosition10.transform.position, Quaternion.identity);
        spawnedAIPlayer5.name = "Team B - P5";
        spawnedAIPlayer5.GetComponent<Player>().Number = 4;
        spawnedAIPlayer5.GetComponent<Player>().Team = team2;
        spawnedAIPlayer5.GetComponent<PlayerInput>().enabled = false;
        spawnedAIPlayer5.GetComponent<Player>().HumanControlled = false;
        spawnedAIPlayer5.GetComponent<CharacterController>().enabled = false;
        team2.Players.Add(spawnedAIPlayer5.GetComponent<Player>());
        //
        ...
        spawnedAIPlayer3.GetComponent<Player>().FellowPlayer = spawnedAIPlayer.GetComponent<Player>();
        spawnedAIPlayer4.GetComponent<Player>().FellowPlayer = spawnedAIPlayer.GetComponent<Player>();
        spawnedAIPlayer5.GetComponent<Player>().FellowPlayer = spawnedAIPlayer.GetComponent<Player>();
    ...
    public void Update()
    {
        ...
        //GridPoint gridPoint = new GridPoint(activeHumanPlayer.transform.position);
        //Debug.Log(string.Format("Human Player position: {0}, {1}", gridPoint.X, gridPoint.Y));
    }

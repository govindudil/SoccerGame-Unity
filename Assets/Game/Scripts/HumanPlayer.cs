...
public class HumanPlayer : MonoBehaviour
{
    ...
    private Vector3[] attackTargetLocation = new Vector3[5];
    ...
    void Update()
    {
        ...
        //Debug.Log(string.Format("{0} {1}", new GridPoint(transform.position).X, new GridPoint(transform.position).Y));
    ...
    {
        Vector3 mostDangerousEnemyPlayer = Game.Instance.PlayerClosestToLocation(1, ownGoalPosition).transform.position;
    ...
    private void MoveToBetweenGoalAndPlayerClosestToGoal()
    {
        ...
        {
            targetLocation = Vector3.Lerp(ownGoalPosition, Game.Instance.Teams[1].Players[scriptPlayer.Number].transform.position, 0.5f);
        }
        ...
        else
        {
            if (Game.Instance.PlayerWithBall == null)
            {
                transform.LookAt(Game.Instance.Teams[1].Players[scriptPlayer.Number].transform.position);
            }
            else if (Game.Instance.PlayerWithBall.Number == scriptPlayer.Number)
            {
